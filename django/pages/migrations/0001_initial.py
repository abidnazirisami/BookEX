# Generated by Django 2.0.3 on 2018-04-22 04:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('topic_name', models.CharField(default='Not available', max_length=500)),
                ('publish_year', models.IntegerField(default=1996)),
                ('publisher', models.CharField(default='Not available', max_length=500)),
                ('amazon_link', models.CharField(default='Not available', max_length=1000)),
                ('edition', models.IntegerField(default=1)),
                ('pages', models.IntegerField(default=1)),
                ('count', models.IntegerField(default=0)),
                ('rating', models.FloatField(default=0.0)),
                ('book_name', models.CharField(default='Not available', max_length=500)),
                ('photo', models.ImageField(default='hootie.jpg', upload_to='')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_name', models.CharField(default='Not available', max_length=500)),
                ('batch', models.IntegerField(default=21)),
                ('roll', models.IntegerField(default=26)),
                ('mail_id', models.CharField(default='Not available', max_length=500)),
