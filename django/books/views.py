...
def addBook(request):
	if request.method == "POST":	
		...
		if (isbnlib.is_isbn10(use_isbn) or isbnlib.is_isbn13(use_isbn)):
		...
		new_book = AddBook()
	return render(request, 'books/donate_book.html', context = {'form':new_book,'message':"Enter a valid isbn"})
